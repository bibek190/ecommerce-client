            ...
            <div className="hero-details d-flex flex-row gap-4 justify-content-center">
              <div className="card" style={{ width: "10rem" }}>
                ...
                <div className="card-body">
                  <p className="card-text text-center">Quick shipping</p>
                </div>
              </div>
              <div className="card" style={{ width: "10rem" }}>
                <img
                ...
                />
                <div className="card-body">
                  <p className="card-text text-center">Fast Order</p>
                </div>
              </div>
              <div className="card" style={{ width: "10rem" }}>
                <img
                ...
                />
                <div className="card-body">
                  <p className="card-text text-center">Save</p>
                </div>
              </div>
              <div className="card" style={{ width: "10rem" }}>
                <img
                ...
                />
                <div className="card-body">
                  <p className="card-text text-center">24/7 support</p>
                </div>
              </div>
              <div className="card" style={{ width: "10rem" }}>
                <img
                ...
                />
                <div className="card-body">
                  <p className="card-text text-center">Online order</p>
                </div>
              </div>
            </div>
          </div>
